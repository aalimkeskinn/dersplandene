...
import { Clock, User, Building, BookOpen, Settings, Wand2, AlertTriangle } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
        <div className="flex items-start">
          ...
          <div>
            <h3 className="text-lg font-medium text-yellow-800 mb-2">Sabit Kısıtlamalar</h3>
